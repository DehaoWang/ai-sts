...
class DungeonGenerator:
    ...
    def generate_act_1_exordium():
        ...
        return [
            {"type": "combat", "generator": lambda: JawWorm(10)},  # 层数 1: 战斗
            {"type": "campfire"},  # 层数 2: 篝火
            {"type": "combat", "generator": lambda: Cultist(20)},  # 层数 3: 战斗
            {"type": "campfire"},  # 层数 2: 篝火
            {"type": "combat", "generator": lambda: JawWorm(20)},  # 层数 3: 战斗
            {"type": "campfire"},  # 层数 2: 篝火
            {"type": "combat", "generator": lambda: Cultist(30)},  # 层数 3: 战斗
...
if __name__ == "__main__":
    ...
    game = SpireClimb(player=chosen_player, deck=chosen_deck, floors=act_1_floors)
    game.start()
